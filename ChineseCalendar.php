...
class ChineseCalendar {
  ...
  /**
   * Get stem name for year|month|day|hour
   * @param integer $type See class constant TYPE_*
   * @param integer $format See class constant FORMAT_*
   * @return string|integer
   */
  public function getStem(int $type=self::TYPE_YEAR, 
                          int $format=self::FORMAT_STRING){
    switch ($type){
    case self::TYPE_YEAR:
  ...
  /**
   * Get branch name for year|month|day|hour
   * @param integer $type See class constant TYPE_*
   * @param integer $format See class constant FORMAT_*
   * @return string|integer
   */
  public function getBranch(int $type=self::TYPE_YEAR,
                            int $format=self::FORMAT_STRING){
    switch ($type){
    case self::TYPE_YEAR:
  ...
  private function daysInGregorianMonth($y, $m) {
  ...
  private function dayOfWeek($y, $m, $d) {
  ...
  private function daysInChineseMonth($y, $m) {
    // Regular month: m > 0
    // Leap month: m < 0
  ...
  private function nextChineseMonth($y, $m) {
  ...
  private function sectionalTerm($y, $m) {
  ...
  private function principleTerm($y, $m) {
    if ($y<1901 || $y>2100) return 0;
    $index = 0;
    $ry = $y-self::BaseYear+1;
...
//  }
   ...
   * @static
   * @param integer $branch_name
   * @return string
   */
  public static function getBranchName(int $branch_num){
